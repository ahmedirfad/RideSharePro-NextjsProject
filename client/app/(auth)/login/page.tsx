    ...
    <div className="min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link href="/register" className="text-sm font-medium text-gray-600 hover:text-blue-600 transition px-4 py-2">
            New here? <span className="font-semibold text-blue-600">Join now →</span>
          </Link>
        </div>
      </nav>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <h1 className="font-bold text-[clamp(36px,5vw,52px)] text-gray-900 leading-tight tracking-tight">
                Sign in to<br />
                <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">your account</span>
              </h1>

              <p className="text-gray-500 text-lg leading-relaxed max-w-md">
                Access your trips, messages, and earnings — all in one place.
              </p>

              {/* Feature Cards */}
              <div className="space-y-4 pt-4">
                {[
                  { icon: Shield, title: 'Safe & Secure', desc: 'ID verified users and Stripe escrow', color: 'text-blue-600', bg: 'bg-blue-50' },
                  { icon: Star, title: '4.8★ Average Rating', desc: 'Trusted by 50,000+ commuters', color: 'text-amber-600', bg: 'bg-amber-50' },
                  { icon: Car, title: 'Real-time Tracking', desc: 'Live location sharing and updates', color: 'text-green-600', bg: 'bg-green-50' },
                ].map((feature, i) => (
              ...
              <div className="flex items-center gap-6 pt-6 border-t border-gray-100">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Join 10,000+ daily riders</p>
                </div>
              </div>
            </div>
